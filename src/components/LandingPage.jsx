...
function LandingPage() {
  return (
    <div>
        ...
        <div className="hero h-90v bg-discord-blue w-screen text-center">
            ...
            <div className='w-80v m-auto mt-4 '>
                <button className="bg-white hover:text-discord-blue text-[#23272a] rounded-md px-2 text-xs font-bold sm:mr-12">
                    <DownloadIcon fontSize="small"/> 
                    Download For Windows
                </button>
                <button className="text-white hover:bg-stone-800 bg-[#23272a] rounded-md px-2 pb-1 text-xs font-bold sm:ml-12">
